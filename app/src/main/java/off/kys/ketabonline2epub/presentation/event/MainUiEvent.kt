...
sealed class MainUiEvent {
    ...
    data class OnDownloadClicked(val bookType: BookType, val bookId: BookId) : MainUiEvent()
    ...
    data class MarkAsDownloaded(val bookType: BookType, val bookId: BookId) : MainUiEvent()
}